#!/usr/bin/env python3
"""
Rename Escape/Escape SDK to escape.
...
REPLACEMENTS = [
    ...
    ("https://github.com/escape/escape", "https://github.com/escape/escape"),
    ("github.com/escape/escape", "github.com/escape/escape"),
    ("escape/escape", "escape/escape"),
    ("github.com/escape/escape", "github.com/escape/escape"),
    ("escape/escape", "escape/escape"),
    # Cache paths
    ("~/.cache/escape", "~/.cache/escape"),
    ("/home/vboxuser/.cache/escape", "/home/vboxuser/.cache/escape"),
    # Organization/Team names
    ("Escape Team", "Escape Team"),
    ("Escape Team", "Escape Team"),
    # Library names (before package names to avoid partial matches)
    ("Escape SDK", "Escape SDK"),
    ("Escape SDK", "Escape SDK"),
    ("Escape", "Escape"),
    ("Escape", "Escape"),
    # Package name (lowercase) - most common
    ("escape", "escape"),
    ("escape", "escape"),
]
...
def main():
    ...
    # Phase 3: Rename package directory (escape/ -> escape/)
    old_pkg_dir = project_root / "escape"
    new_pkg_dir = project_root / "escape"
    ...
    if not args.dry_run:
        print("\nNext steps:")
        print("  1. Update symlink: ln -sf /home/vboxuser/.cache/escape/generated escape/generated")
        print("  2. Rename project directory manually: mv Escape-SDK escape-SDK")
        print("  3. cd escape-SDK")
        print("  4. python -c 'import escape'  # Verify import works")
        print("  5. Run tests if available")
