...
if TYPE_CHECKING:
    from escape_sdk.types import Point, Quad
    from escape_sdk.world.projection import TileGrid
...
class VisibleTiles:
    ...
    def getScreenPoint(self, i: int) -> "Point":
        ...
        from escape_sdk.types import Point
...
class Scene:
    ...
    Example:
        >>> from escape_sdk.world.scene import scene
        >>>
    ...
    def _getPlayerScenePos(self) -> Tuple[int, int] | None:
        ...
        from escape_sdk.globals import getEventCache
