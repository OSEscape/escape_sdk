...
from escape_sdk.types.box import Box
from escape_sdk.types.circle import Circle
from escape_sdk.types.point import Point
from escape_sdk.types.polygon import Polygon
from escape_sdk.types.quad import Quad
...
class Visualizer:
    ...
    Example:
        >>> from escape_sdk._internal.visualizer import Visualizer
        >>>
        >>> viz = Visualizer()
