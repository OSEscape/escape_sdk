        ...
        for method_name, signatures in self.methods.items():
            for sig_info in signatures:
                if isinstance(sig_info, list) and len(sig_info) >= 2:
                    ...
                    # Keep declaring_class in JNI format (with slashes)
...
This file is stored in ~/.cache/escape_sdk/generated/ and uses absolute imports.
"""

from __future__ import annotations
from typing import Any, List, Union, Optional, TYPE_CHECKING
from escape_sdk._internal.query_builder import QueryRef

if TYPE_CHECKING:
    from escape_sdk._internal.query_builder import Query
