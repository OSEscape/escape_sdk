...
class ResourceUpdater:
    ...
    def shouldUpdate(self) -> Tuple[bool, str]:
        ...
        """
        from escape_sdk._internal.cache_manager import (
            _needsUpdate,
            getCacheManager,
        )
...
Examples:
  ...
  python -m escape_sdk._internal.updater.resources

  # Force update
  python -m escape_sdk._internal.updater.resources --force

  # Check status only
  python -m escape_sdk._internal.updater.resources --status
""",
    )
