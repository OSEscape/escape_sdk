...
Handles updating all escape_sdk data:
- RuneLite API data
...
def main():
    """Command-line interface for escape_sdk updater"""
    import argparse
...
Examples:
  ...
  python -m escape_sdk._internal.updater

  # Force update everything
  python -m escape_sdk._internal.updater --force

  # Check status of all data
  python -m escape_sdk._internal.updater --status

  # Update only RuneLite API (skip resources)
  python -m escape_sdk._internal.updater --api-only

  # Update only resources (skip API)
  python -m escape_sdk._internal.updater --resources-only

  # Clean temporary files
  python -m escape_sdk._internal.updater --clean
""",
    )
