...
from escape_sdk.generated.constants.varclient import VarClientStr

logger = logging.getLogger(__name__)

if TYPE_CHECKING:
    from escape_sdk._internal.cache.event_cache import EventCache
    from escape_sdk.generated.constants.animation_id import AnimationID
    from escape_sdk.generated.constants.interface_id import InterfaceID
    from escape_sdk.generated.constants.item_id import ItemID
    from escape_sdk.generated.constants.npc_id import NpcID
    from escape_sdk.generated.constants.object_id import ObjectID
    from escape_sdk.generated.constants.sprite_id import SpriteID
    from escape_sdk.generated.constants.varclient_id import VarClientID
    from escape_sdk.input import Input
    from escape_sdk.interactions import Interactions
    from escape_sdk.interfaces import Interfaces
    from escape_sdk.navigation import Navigation
    from escape_sdk.player import Player
    from escape_sdk.tabs import Tabs
    from escape_sdk.world import World
...
class Client:
    ...
    def _init(self):
        ...
        from escape_sdk._internal.cache_manager import ensureResourcesLoaded
        ...
        from escape_sdk._internal.cache.event_cache import EventCache
        from escape_sdk._internal.events.consumer import EventConsumer
        ...
        import escape_sdk.world.projection  # noqa: F401

        self._event_consumer.start(wait_for_warmup=True)

        # Register for automatic cleanup on exit
        from escape_sdk._internal.cleanup import registerApiForCleanup
    ...
    def player(self) -> "Player":
        ...
        """
        from escape_sdk.player.player import player
    ...
    class _ResourcesNamespace:
        ...
        def varps(self):
            ...
            from escape_sdk._internal.resources import varps
        ...
        def objects(self):
            ...
            from escape_sdk._internal.resources import objects
